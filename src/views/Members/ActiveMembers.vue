      ...
      <v-col>
        <v-card>
          <v-container>
            ...
            <v-data-table :headers="headers" :items="approvedMembers" :search="search"  :loading="loading ? true : false" loading-text="Loading... Please wait" disable-pagination hide-default-footer>
...
export default {
  ...
  computed: {
    ...mapState(['approvedMembers', 'loading'])
  }
}
</script>
